...
- (void)setCheckboxItems:(NSArray *)checkboxItems{
    ...
    NSInteger   row             = 0;
    NSInteger   yPos            = 0;
    UIImage     *offImage       = [UIImage imageNamed:kOffImage];
...
- (void)toggleCheckbox:(id)sender{
    ...
    if([_selectedCheckboxItems containsObject:checkboxItem]){
        ...
        [checkbox setImage:[UIImage imageNamed:kOffImage] forState:UIControlStateNormal];
    }else{
        [_selectedCheckboxItems addObject:checkboxItem];
        [checkbox setImage:[UIImage imageNamed:kOnImage] forState:UIControlStateNormal];
    }
